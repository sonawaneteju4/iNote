...
import import LoginIcon from '@mui/icons-material/Login'; from '@mui/icons-material/Delete';
  ...
  return (
    <nav className='flex bg-black text-white sticky top-0'>
        <ul className='flex m-3'>
            ...
            <Button className='flex justify-end' variant="outlined" startIcon={<DeleteIcon />}>
        Delete
      </Button>
        </ul>
