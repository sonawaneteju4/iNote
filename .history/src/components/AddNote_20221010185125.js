...
const AddNote = () => {
  ...
  <div className="relative z-0 mb-6 w-full group">
      ...
      <input  onChange={onChange} type="text" name="title" id="title" className=" py-2.5 px-0 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Enter Your Title" required=""/>
  </div>
  <div className="relative z-0 mb-6 w-full group">
