  ...
  return (
    <div>
      <div className="flex flex-row justify-between">
        ...
        {showModal && <NoteModal closeModal = {setShowModal} openForUpate = {true}/>}
        {showModalForUpdate && <NoteModal closeModal = {setShowModalForUpdate} openForUpate = {forUpdate}/>}
      </div>

      <div className="flex flex-wrap">
        {notes.map((note) => {
          return (<div  key={note._id} onClick ={() =>setShowModalForUpdate(true)} >
            {
