...
const AddNote = () => {
  ...
  <div className="relative z-0 mb-6 w-full group">
      ...
      <input  onChange={onChange} type="text" name="title" id="title" className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Your Title" required=""/>
  </div>
  <div className="relative z-0 mb-6 w-full group">
