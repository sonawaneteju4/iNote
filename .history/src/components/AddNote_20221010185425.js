...
const AddNote = () => {
  ...
  <div className="relative z-0 mb-6 w-full group">
      ...
      <input onChange={onChange} type="desc" name="desc" id="description" className="block p-4 w-96 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700" placeholder="description" required=""/>
  </div>
