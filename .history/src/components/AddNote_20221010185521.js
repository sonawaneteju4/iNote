...
const AddNote = () => {
  ...
  <div className="relative z-0 mb-6 w-full group">
      <label for="" className="block mb-2 text-sm font-medium text-gray-900">Title</label>
  ...
  <div className="relative z-0 mb-6 w-full group">
      <label for="floating_password" className="block mb-2 text-sm font-medium text-gray-900">description</label>
      <input onChange={onChange} type="desc" name="desc" id="description" className="block p-4 w-96 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500" placeholder="description" required=""/>
  </div>
