  ...
  return (
    <div>
      <div className="flex flex-row justify-between">
        ...
        {showModal && <NoteModal closeModal = {setShowModal} title = {title} description = {description}/>}
        {showModalForUpdate && <NoteModal closeModal = {setShowModalForUpdate} title = {title} description = {description}/>}
      </div>
